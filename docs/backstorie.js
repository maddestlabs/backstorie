...
class BackstorieTerminal {
    constructor(canvasElement) {
        ...
        // Font settings
        this.fontSize = 16;
        this.fontFamily = "'Courier New', 'Consolas', 'Monaco', monospace";
...
function initBackstorie() {
    try {
        ...
        console.log('Backstorie initialized successfully');
    } catch (error) {
